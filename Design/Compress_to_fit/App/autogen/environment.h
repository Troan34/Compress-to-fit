...
Q_IMPORT_QML_PLUGIN(Compress_to_fitPlugin)
Q_IMPORT_QML_PLUGIN(Compress_to_fitContentPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/Compress_to_fitContent/App.qml";
